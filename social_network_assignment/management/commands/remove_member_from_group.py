...
from social_network_assignment.utils import remove_member_from_group
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            # print(user_id)
            # print(name)
            print(remove_member_from_group(user_id=user_id, member_id=member_id, group_id=group_id))
